...
Source0  : https://cpan.metacpan.org/authors/id/A/AZ/AZJADFTRE/HTML-Clean-0.9.tar.gz
...
%prep
%setup -q -n HTML-Clean-0.9
cd ..
%setup -q -T -D -n HTML-Clean-0.9 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/HTML-Clean-0.9/deblicense/
