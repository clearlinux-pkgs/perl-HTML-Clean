...
Source0  : https://cpan.metacpan.org/authors/id/A/AZ/AZJADFTRE/HTML-Clean-1.2.tar.gz
...
%prep
%setup -q -n HTML-Clean-1.2
cd ..
%setup -q -T -D -n HTML-Clean-1.2 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/HTML-Clean-1.2/deblicense/
